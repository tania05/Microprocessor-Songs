...
#define		LCD_DISPLAY_ON			(u8)0x04		/* Bit set to 1 to turn display on */
#define		LCD_DISPLAY_CURSOR	(u8)0x02		/* Bit set to turn cursor on */
#define		LCD_DISPLAY_BLINK		(u8)0x01		/* Bit set to have cursor blink on */
