...
Requires:
  - u32Channel_ is the channel of interest - either RIGHT_BUZZER (AT91C_PWMC_CHID0) or LEFT_BUZZER (AT91C_PWMC_CHID1)
...
#ifdef MPGL1 
  else if(u32Channel_ == LEFT_BUZZER)
  {
