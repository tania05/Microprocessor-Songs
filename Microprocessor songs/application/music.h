...
***********************************************************************************************************************/
/* Note lengths */
#define MEASURE_TIME2              (u16)2000  /* Time in ms for 1 measure (1 full note) - should be divisible by 8*/
#define FULL_NOTE2                 (u16)(MEASURE_TIME)
#define HALF_NOTE2                 (u16)(MEASURE_TIME / 2)
#define QUARTER_NOTE2              (u16)(MEASURE_TIME / 4)
#define EIGHTH_NOTE2               (u16)(MEASURE_TIME / 8)
#define SIXTEENTH_NOTE2            (u16)(MEASURE_TIME / 16)

#define FN2                        FULL_NOTE                 
#define HN2                        HALF_NOTE                 
#define QN2                        QUARTER_NOTE              
#define EN2                        EIGHTH_NOTE               
#define SN2                        SIXTEENTH_NOTE            

/* Note length adjustment: watch for rounding errors - always round up */
#define REGULAR_NOTE_TIME2         (u16)((QUARTER_NOTE / 3) + 1)
#define STACCATO_NOTE_TIME2        (u16)((QUARTER_NOTE * 2 / 3) + 1)
#define HOLD_NOTE_TIME            (u16)0

#define RT                        REGULAR_NOTE_TIME
#define ST                        STACCATO_NOTE_TIME        
#define HT                        HOLD_NOTE_TIME            
