...
Runtime switches
***********************************************************************************************************************/
#define MPGL1             /* Activates MPG Level 1 specific code */
//#define MPGL2           /* Activates MPG Level 2 specific code */

#define STARTUP_SOUND     /* Enables startup sound */  
#define DEBUG_MODE        /* Enable certain debugging code */
...
/*----------------------------------------------------------------------------------------------------------------------
%BUZZER% Button Configuration                                                                                                  
------------------------------------------------------------------------------------------------------------------------
Update the values below for the buzzers on the board. 
*/

#define BUZZER0               AT91C_PWMC_CHID0
#define BUZZER1               AT91C_PWMC_CHID1
